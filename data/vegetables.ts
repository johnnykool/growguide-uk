...
export const VEGETABLES: Vegetable[] = [
  ...
  },
  {
    ...
    difficulty: "Easy",
    notes:
      "Peas dislike heat, so UK springs suit them well. Sow every 3–4 weeks March–June for a long season; early sowings under cloches in February in mild areas. Sow a mildew-resistant variety like 'Hurst Green Shaft' for later crops. Starting in guttering under cover and sliding rows into the ground beats mice and slugs.",
  },
  ...
  // ── Brassicas ─────────────────────────────────────────────
  {
    ...
    pruningCare:
      "Plant firmly, because brassicas hate loose soil, and fit brassica collars against cabbage root fly. Net against pigeons and butterflies from day one. Water well in dry spells. Cut the central head while buds are tight; side shoots then crop for weeks afterwards.",
